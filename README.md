...
# @swenkerorg/libero-corrupti-cumque

[![Build Status](https://travis-ci.com/swenkerorg/libero-corrupti-cumque.svg?branch=main)](https://travis-ci.com/swenkerorg/libero-corrupti-cumque)
...
```
npm install @swenkerorg/libero-corrupti-cumque
```
...
const postcssHtmlFilter = require('@swenkerorg/libero-corrupti-cumque');
const fs = require('fs');
